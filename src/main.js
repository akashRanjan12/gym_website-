...
function setupCustomCursor() {
  ...
  const clickables = document.querySelectorAll("a, button, select, input, textarea, .gallery-item, .schedule-tab-btn, .unit-btn");
...
function setupInteractiveMap() {
  ...
  L.marker(coords, { icon: customIcon }).addTo(map)
    .bindPopup('<b>IRON PEAK GYM</b><br>108 Peak Boulevard, NY 10001<br><a href="https://maps.google.com" target="_blank" style="color: #ffcc00; font-weight: bold; font-size: 11px;">GET DIRECTIONS</a>')
    .openPopup();
}
